                                    ...
                                    <tbody>
                                        @foreach ($transaksi as $transaksiItem)
                                            <tr>
                                                ...
                                                <td>{{ $transaksiItem->nama }}</td>
                                                <td>{{ $transaksiItem->status }}</td>
                                                <td>
                                                    <form action="{{ route('transaksi.approve', $transaksiItem->id) }}"
                                                        method="POST" style="display:inline-block;">
                                                        @csrf
                                                        <button type="submit" class="btn btn-success">Setuju</button>
                                                    </form>

                                                    <form action="{{ route('transaksi.reject', $transaksiItem->id) }}"
                                                        method="POST" style="display:inline-block;">
                                                        @csrf
                                                    ...
                                                    <form
                                                        action="{{ route('transaksi.process', $transaksiItem->id) }}"
                                                        method="POST" style="display:inline-block;">
                                                        @csrf
                                                        <button type="submit"
                ...
                <footer class="sticky-footer bg-white">
                    <div class="container my-auto">
                        <div class="copyright text-center my-auto">
                            <span>Copyright &copy; reslab unand 2024</span>
                        </div>
                    </div>
                </footer>
                <!-- End of Footer -->
