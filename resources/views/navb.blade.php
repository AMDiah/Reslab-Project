...
*/
    ...
    .parent-div {
        ...
        height: calc(0.71 * var(--custom-width));
        overflow: hidden;
        margin: auto;
        padding: 0px;
    ...
    .layout-main1-15 {
        ...
        z-index: -10;
        transform: rotate(0deg);
        border-radius: 0px 0px 1000px 20px;
        background: linear-gradient(162.95deg,
                #fe6601ff 0%,
                #ff8d36ff 48%,
                #ffa243ff 100%);
    }
    ...
    .rectangle-26-57473 {
        ...
        z-index: 0;
        transform: rotate(0deg);
        background: linear-gradient(90deg, #ffa243ff 0%, #fe6601ff 100%);
    }
    ...
    .ellipse-1-1817 {
        ...
        border-radius: 50%;
        background: #eb933aff;
        box-shadow: 4px 4px 28px 0px rgba(30, 30, 30, 1);
    }
